// ignore: prefer_mixin
import '../../core/flutter_engine.dart';
...
// ignore: prefer_mixin
abstract class DeexStore extends ListNotifier with DeexLifeCycleMixin {
  /// Rebuilds `DeexStore` each time you call `update()`;
  /// Can take a List of [ids], that will only update the matching [ids].
...
/// top
mixin ScrollMixin on DeexLifeCycleMixin {
...
/// A controller with super lifecycles (including native lifecycles)
abstract class FullLifeCycleController extends DeexStore
    with
        // ignore: prefer_mixin
