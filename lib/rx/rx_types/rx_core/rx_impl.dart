...
/// global object that registers against `Deex`, and allows the
/// reactivity
/// of those `Widgets` and Rx values.

mixin DeexObjectMixin<T> on DeexListenable<T> {
  //late T _value;
  ...
  bool operator ==(Object o) {
    ...
    if (o is DeexObjectMixin<T>) return value == o.value;
    return false;
  }
  ...
  /// Widget (`Deex`) gets unmounted from the Widget tree.
...
abstract class _RxImpl<T> extends DeexListenable<T> with DeexObjectMixin<T> {
