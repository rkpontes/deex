...
import '../../state_manager/rx_flutter/rx_notifier.dart';
...
///
/// class _CountStore extends DeexStore {
///   final count = 0.obs;
///   Worker worker;
///
///   void onInit() {
...
/// Sample:
/// ```
///  class _CountStore extends DeeStore {
///   final count = 0.obs;
///   Worker worker;
///
///   @override
